...
if("TRUE" STREQUAL "TRUE")
  set(motors_SOURCE_PREFIX /home/pi/ennomotive_challenge/ros_main_ws/src/motors)
  set(motors_DEVEL_PREFIX /home/pi/ennomotive_challenge/ros_main_ws/devel)
  set(motors_INSTALL_PREFIX "")
  set(motors_PREFIX ${motors_DEVEL_PREFIX})
else()
  set(motors_SOURCE_PREFIX "")
  set(motors_DEVEL_PREFIX "")
  set(motors_INSTALL_PREFIX /home/pi/ennomotive_challenge/ros_main_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'motors' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Maria Ramos <m.ramos@ortelio.co.uk>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'motors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ennomotive_challenge/ros_main_ws/src/motors/${idir}'.  Ask the maintainer 'Maria Ramos <m.ramos@ortelio.co.uk>' to fix it.")
    endif()
